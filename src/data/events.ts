...
export const events: EventData[] = [
  ...
  {
    title: "NeuroVerse",
    category: "ML Prediction Model",
    description: "Dive into the world of Machine Learning! Build, train, and optimize predictive models to analyze complex datasets and solve real-world industry challenges.",
    date: "Day 1",
